...
const FEATURES = [
  {
    icon: '💊',
    label: 'NGUYÊN LIỆU TUYỂN CHỌN',
    title: 'Hàm Lượng Hoạt Chất Cao',
    body: 'Chỉ sử dụng Tam thất Bắc được lựa chọn theo tiêu chuẩn của thương hiệu.',
  },
  {
    icon: '🚫',
    label: 'KHÔNG PHA TRỘN',
    title: '100% Tam thất Bắc xay mịn.\n\nKhông thêm phụ gia hay hương liệu.',
    body: 'Không phụ gia, không chất tạo màu, không lưu huỳnh. Phơi tự nhiên và sấy lạnh bảo toàn dưỡng chất tối đa.',
  },
  {
    icon: '🏔️',
    label: 'SƠ CHẾ CẨN THẬN',
    title: 'Nguyên liệu được làm sạch, sấy và nghiền phù hợp để giữ hương thơm tự nhiên.',
  ...
  {
    icon: '🌱',
    label: 'NGHIỀN THEO TỪNG MẺ',
    title: 'Giúp sản phẩm luôn mới, hạn chế lưu kho quá lâu.',
  ...
  },
  {
    icon: '♻️',
    label: 'ĐÓNG GÓI KÍN',
    title: 'Giúp bảo quản tốt hơn trong quá trình sử dụng.',
